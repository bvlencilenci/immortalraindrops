...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-[64px] z-[100] bg-[#050505cc] backdrop-blur-md flex items-center justify-between px-1 relative overflow-hidden border-none text-white">
      ...
      <div className="flex items-center gap-12 z-20 overflow-hidden pl-1 h-full">
        <h1 className="font-mono text-xs uppercase tracking-[0.3em] whitespace-nowrap">
          Immortal Raindrops
        </h1>

        {isPlayerActive && (
          <div className="flex flex-col py-1 overflow-hidden max-w-[400px]">
      ...
      >
        ...
        <div
          className="h-full bg-white relative translate-y-0"
