...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-20 z-50 bg-black/80 backdrop-blur-md flex items-center justify-between px-[12px] md:px-[20px] border-b border-white/10 text-white overflow-hidden">
