...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-12 z-[100] bg-[#050505cc] backdrop-blur-md flex items-center justify-between px-1 border-none text-white overflow-hidden">
