  ...
  return (
    <div className={`flex items-center justify-center gap-3 z-50 ${className}`} data-testid="playback-controls">
      {!isRadioStream && (
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="w-7 h-7" fill="#ECEEDF">
      ...
      <div>
        <button
          ...
          className="opacity-75 transition-all duration-100 flex items-center justify-center whitespace-nowrap cursor-pointer hover:scale-110 active:scale-95"
